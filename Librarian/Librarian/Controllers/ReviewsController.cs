...
namespace Librarian.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Content,Rating,BookId,UserId")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Content,Rating,BookId,UserId")] Review review)
        {
            if (ModelState.IsValid)
            {
